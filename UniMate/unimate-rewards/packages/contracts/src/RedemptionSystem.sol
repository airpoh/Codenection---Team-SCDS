...
contract RedemptionSystem is Ownable, ReentrancyGuard, EIP712 {
    ...
    ) Ownable(initialOwner) EIP712("UniMate RedemptionSystem", "1") {
    ...
    function setPointsToWellRate(uint256 newRate) external onlyOwner {
